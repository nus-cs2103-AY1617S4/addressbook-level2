...
public class AddCommand extends Command {
	 ...
	 */
	public AddCommand(String name, String phone, boolean isPhonePrivate, String email, boolean isEmailPrivate,
	...
	public CommandResult execute() {
		try {
			...
			System.out.println("|| Person's sequence number is: " + toAdd.getSequenceNumber()
					+ " and next sequence number is: " + Person.getNextSequenceNumber());
