...
public class AddCommandTest {
    ...
    public void addCommand_validData_correctlyConstructed() throws Exception {
        ...
        assertEquals(Phone.EXAMPLE, p.getPhone().getPhoneValue());
        assertTrue(p.getPhone().isPrivate());
        assertEquals(Email.EXAMPLE, p.getEmail().getEmailValue());
        assertFalse(p.getEmail().isPrivate());
        assertEquals(Address.EXAMPLE, p.getAddress().getAddressValue());
